...
public class TestCourse {
	...
	public static void main (String[]args) {
		...
		for (String std: new String[]{"Siti Aminah Muhammad", "Halim Zainal Abidin", "Jason Lim", "Abb", "Qiu","Jake"})	//6 students
			course1.addStudent(std);
		printStudents(course1);
		
		Course course2 = new Course("Database Systems");
		for (String std: new String[] {"a","b","c","d","e","f","g","h","i"})	//9 students
